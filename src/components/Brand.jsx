...
const Brand = () => {
  ...
  return (
    <div>
      <h2 className="text-3xl font-bold text-blue-400 text-center my-5">
        Get Information About the Brands!!!
      </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
        {brands.map(({ description, brand_name, brand_logo, coupons }, _id) => (
          <div key={brands._id} className="p-5 border rounded shadow">
            ...
            <p className="text-center text-gray-600 my-2 text-xl font-semibold">
              {description}
            </p>
            ...
            <div>
              <NavLink to={`/couponDetails/${_id}`}>
                <button className="mt-2 px-4 py-2 bg-sky-600 hover:bg-red-600 glass text-white rounded-lg">
                 View coupons
                </button>
              </NavLink>
            </div>
